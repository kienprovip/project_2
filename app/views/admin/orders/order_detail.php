                        ...
                        <div class="cancel-contact mb-3 d-flex justify-content-center justify-content-sm-end px-3">
                            <div>
                                <?php if ($order['order_status'] == 1) {
                                    echo '<form action="/project_2/Admin/processOrder" method="POST">
                                    <input type="text" name="order_id" value="' . $order["order_id"] . '" hidden>
                                    <button class="ms-3 px-3 py-1" name="cancel">Cancel</button>
                                    <button class="ms-3 px-3 py-1" name="accept">Accept</button>
                                </form>
                                ';
                                } ?>
                            </div>
